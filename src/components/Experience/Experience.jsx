...
const EXPERIENCES = [
  {
    ...
    points: [
      ...
      'Developed and optimized a scalable CRM platform using React.js, JavaScript, Redux, Tailwind CSS, and reusable component architecture.',
      'Built and delivered key CRM features, improving application usability, workflow efficiency, and overall user experience.',
      'Resolved authentication and session management issues, enhancing application reliability and login performance.',
      'Integrated REST APIs, analytics dashboards, and managed application state using Redux and Context API for real-timedata flow',
      'Developed full-stack functionality using Node.js, Express.js, and MongoDB, including responsive UI development, form validation, and production deployment via cPanel.'
    ],
  },
  // {
  //   type: 'work',
